...
# ============================================================
#  Deploy Azure ML Online Endpoint + Blue Deployment
...
DEPLOYMENT_YML="infrastructure/azure/endpoints/blue/deployment-blue.yml"
...
# -----------------------------
echo "🚀 Creating/updating endpoint: $MODEL_ENDPOINT_NAME"
...
echo "✅ Blue endpoint + deployment are ready (model ${MODEL_VERSION})."
